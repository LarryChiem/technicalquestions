...
public class ThreadExample {
    public static void main(String[] args) throws InterruptedException {
       ...
       // Create producer thread
        ...
        // t1 (producer) finishes before t2 (consumer)
        t1.join();
        t2.join();
    }

    // This class has a list, producer (adds items to list), and consumer (removes items from list)
        ...
        public void produce() throws InterruptedException {
            ...
            while (true) {
                synchronized (this) {
                    ...
                    // The reason is simple, once you have something in list, you can have the consumer thread consume it, or if you have consumed something, you can have the producer produce something.
                    notify();
